...
1. What is the DOM?
    It is the object for the entire html document model.

2. What is an event?
    An event is something that happens as a result of certain actions such as loading a page or clicking an object

3. What is an event listener?
    An event listener is an function which allows you to either intercept an default action or allows you to write custom actions;

4. Why would we convert a NodeList into an Array?
    Because a NodeList doesn't provide access to all of the Array methods.

5. What is a component?
    A component is a custom wrapper class for a default HTML element that allows you to add custom functionality.
